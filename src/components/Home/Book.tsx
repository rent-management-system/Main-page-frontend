...
const Book = () => {
  ...
  const { isButtonClicked, handleButtonClick, loading, handleLoading, isReserveClicked } = useContext(MyContext) as any;
    ...
    <div className="book" id="rental">
      ...
      <form className="book-form" action="../Server/server" method="post" onSubmit={handleSubmit}>
        <div className="select-cont1">
          <div className="topic">
            <img src="property_type.png" alt="" />
            <p>
              Select Property Category<b>*</b>
            </p>
          </div>
          <select
            required
